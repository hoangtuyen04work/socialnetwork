...
public class AuthenticationService implements AuthenticationServiceInterface {
    ...
    public AuthenticationResponse login(UserRequest userRequest) throws AppException, JOSEException {
        UserEntity user = userService.findByUserId(userRequest.getId());
    ...
    public AuthenticationResponse signup(UserRequest userRequest) throws JOSEException, AppException {
        if(userService.existed(userRequest.getId())){
    ...
    private void setRoleUser(UserEntity userEntity){
    ...
    public AuthenticationResponse update(UserRequest userRequest) throws AppException, JOSEException {
        if(userRequest.getId() != SecurityContextHolder.getContext().getAuthentication().getName()){
            throw new AppException(ErrorCode.NOT_AUTHENTICATED);
        }
        UserEntity userEntity = userService.update(userRequest);
